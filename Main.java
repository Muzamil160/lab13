...
public class Main {
    ...
    String[] countryList={"England","Sri Lanka","Bangladesh","New Zealand","Pakistan","India","Australia"};
...
//                    panel1.setLayout(null);
    ...
    public static void main(String[] args) {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/awahab", "root", "1234");
        }catch(Exception ex) {
